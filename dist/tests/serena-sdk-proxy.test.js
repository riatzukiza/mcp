...
test.serial('serena-sdk-proxy › Serena server initializes successfully with SDK proxy', async (t) => {
    ...
    if (proxy.getServerCapabilities) {
        ...
        t.true(typeof capabilities === 'object' && capabilities !== null, 'Capabilities should be an object');
    }
...
//# sourceMappingURL=serena-sdk-proxy.test.js.map