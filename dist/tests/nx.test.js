...
import { __test__, buildNxGenerateArgs, resolvePreset, } from '../tools/nx.js';
const noopFetch = async (..._args) => {
...
test('nx_generate_package tool normalizes inputs', async (t) => {
    const executor = async (args) => makeResult(args);
...
//# sourceMappingURL=nx.test.js.map