import { z } from 'zod';
import { getMcpRoot, listDirectory, treeDirectory, viewFile, writeFileContent, writeFileLines, } from '../files.js';
// Unified sandbox-root resolver
// If MCP_ROOT_PATH isn't set, default to CWD at runtime.
const resolveRoot = () => getMcpRoot();
export const filesListDirectory = () => {
    const shape = {
...
export const filesTreeDirectory = () => {
    const shape = {
        rel: z.string().default('.'),
        includeHidden: z.boolean().optional(),
...
export const filesWriteFileContent = () => {
    const shape = {
        filePath: z.string(),
        content: z.string(),
    };
...
export const filesWriteFileLines = () => {
    const shape = {
        filePath: z.string(),
