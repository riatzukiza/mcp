...
export class AuthenticationFactory {
    ...
    static async createSystem(config) {
        ...
        if (config.oauth?.enabled) {
            ...
            if (system.userRegistry) {
                ...
                system.oauthIntegration = new OAuthIntegration(oauthIntegrationConfig, system.oauthSystem, system.jwtManager, system.userRegistry, system.authManager);
            }
        }
        return system;
    }
     ...
     */
    static createUserRegistryConfig(config) {
        if (!config) {
     ...
     */
    static createOAuthSystemConfig(config) {
        if (!config) {
     ...
     */
    static createOAuthIntegrationConfig(config) {
        if (!config) {
            throw new Error('OAuth configuration is required');
        }
    ...
    static validateOAuthConfig(config) {
        ...
        else if (!oauth.redirectUri.startsWith('http://') &&
...
`;
     ...
     */
    static async setupOAuthDirectories(config) {
