 ...
 */
export function validatePathSecurity(rel) {
 ...
 */
export function validateSinglePath(inputPath) {
 ...
 */
export function validatePathArrayFull(inputPaths) {
 ...
 */
export async function validateMcpOperation(rootPath, targetPath, _operation = 'read') {
 ...
 */
export function validateGitHubOperation(args) {
    ...
    try {
        ...
        if (validated.path) {
            ...
            if (!pathValidation.valid) {
                return {
                    success: false,
                    error: new Error(`GitHub path validation failed: ${pathValidation.securityIssues?.join(', ')}`),
                };
            }
 ...
 */
export function validatePnpmOperation(args) {
    const schema = z.object({
    ...
    try {
        ...
        if (validated.cwd) {
            ...
            if (!cwdValidation.valid) {
                return {
                    success: false,
                    error: new Error(`PNPM working directory validation failed: ${cwdValidation.securityIssues?.join(', ')}`),
                };
            }
        }
        return { success: true, data: validated };
 ...
 */
export function validateNxOperation(args) {
    const schema = z.object({
 ...
 */
export function validateTddOperation(args) {
    const schema = z.object({
    ...
    try {
        ...
        if (validated.cwd) {
            ...
            if (!cwdValidation.valid) {
                return {
                    success: false,
                    error: new Error(`TDD working directory validation failed: ${cwdValidation.securityIssues?.join(', ')}`),
                };
            }
        }
        return { success: true, data: validated };
 ...
 */
export function validateSearchOperation(args) {
    const schema = z.object({
    ...
    try {
        ...
        if (validated.rel) {
            ...
            if (!pathValidation.valid) {
                return {
                    success: false,
                    error: new Error(`Search path validation failed: ${pathValidation.securityIssues?.join(', ')}`),
                };
            }
        }
 ...
 */
export function validateMcpTool(toolName, args) {
    switch (toolName) {
        case 'github_request':
        case 'github_graphql':
        ...
        default:
            ...
            const checkStringForDanger = (value) => {
